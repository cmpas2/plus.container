describe('Container', function () {
  ...
  it('ability to (extend) parent service with child container (provide)', function () {
    ...
    child.provide('B', function (container) {
      return container.parent.connect;
    });
    ...
    connect1.should.be.equal(connect);

  });

  it('ability to (extend) parent service with child container (provide) while maintaining parent identity', function () {
    ...
    parent.should.be.equal(container);

  });

  it('ability to (extend) parent service with child container inheritance of registry', function () {
    ...
    let connect1 = child.get('connect');
    connect1.should.be.equal(connect);

  });

  it('ability to (extend) parent service with child container inheritance of registry with child overwrite', function () {
    ...
    let connect2 = function connect2() {
      return {ok: 'ok2'};
    };
  ...
  it('should allow to (chain) register class with dependencies', function () {
    ...
    var myService2 = container.get('myService2');

    myService2.dep1.name.should.be.equal(MyClass1.name);
    myService2.dep2.should.be.equal(myConfig);
